            ...
            <div class="m-portlet__head-tools">
                <ul class="nav nav-pills nav-pills--brand m-nav-pills--align-right m-nav-pills--btn-pill m-nav-pills--btn-sm"
                    ...
                    <li class="nav-item m-tabs__item">
                        <a class="nav-link m-tabs__link active" href="{{ route('section.create') }}">
                ...
                <table class="table text-nowrap table-hover table-striped">
                    <thead class="bg-faded">
                        <tr>
                            ...
                            <th style="min-width: 150px;">Academic year</th>
                    ...
                    <tbody class="p-0">
                        ...
                        <tr>
                            ...
                            <td>{{$section->name }}</td>
                            <td>{{$section->stream->title}}</td>
                            <td>{{$section->academicYear->academic_year}}</td>
                            <td class="row"><a href="{{ route('section.edit', $section->id) }}" class="btn btn-primary btn-sm mx-1">Edit</a>
                                    <form class="p-0"
